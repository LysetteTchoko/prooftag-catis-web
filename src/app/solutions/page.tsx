...
export default function SolutionsPage() {
  return (
    <main className="min-h-screen bg-background">
      <PageHeader
        eyebrow="Solutions"
        title="Des solutions numériques pour sécuriser, vérifier et tracer."
        description="PROOFTAG-CATIS développe des solutions adaptées aux environnements sensibles, avec une attention particulière portée à la sécurité documentaire, à la vérification numérique et à la traçabilité."
      />
